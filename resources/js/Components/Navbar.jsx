...
export default function Navbar() {
    ...
    return (
        ...
        <div className="bg-base-100 text-base-content sticky top-0 z-30 flex h-16 w-full justify-center  transition-shadow duration-100 
  shadow-sm px-7 md:px-[7.5em]">
            <nav className="navbar w-full">
                <div className="flex-1 ">
                    ...
                    <button onClick={() => changeLanguage(i18n.language === 'en' ? 'id' : 'en')} className="btn btn-ghost">
                ...
                <div className="flex-none">
                    <ul className="menu menu-horizontal px-1 hidden lg:flex md:static">
                        <li className="md:ml-8 md:my-0 my-7 text-base font-body">
                            <ScrollLink to="home" href="#home" smooth={false} offset={-500} duration={500} className="text-body  hover:text-indigo-500 transition duration-300 font-normal">Home</ScrollLink>
                        </li>
                        <li className="md:ml-8 md:my-0 my-7 text-base font-body">
                            <ScrollLink to="travel" href="#travel" smooth={true} offset={-20} duration={500} className="text-body  hover:text-indigo-500 transition duration-300 font-normal">K-One Travel</ScrollLink>
                        </li>
                        <li className="md:ml-8 md:my-0 my-7 text-base font-body">
                            <ScrollLink to="minibank" href="#minibank" smooth={true} offset={-150} duration={500} className="text-body  hover:text-indigo-500 transition duration-300 font-normal">Mini Bank</ScrollLink>
                        </li>
                    ...
                    <ul className={`lg:hidden cursor-pointer md:flex md:items-center md:pb-0 pb-12 md:static z-[100] left-0 w-full md:w-auto md:pl-auto pl-9 transition-all duration 500 ease-in-out absolute  ${open ? 'top-16 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]  bg-base-100' : 'top-[-100vh]'}`}>
                        <li className="md:ml-8 md:my-0 my-7 text-base font-body">
