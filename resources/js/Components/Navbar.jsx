    ...
    return (
        <div className="shadow-md w-full fixed top-0 left-0">
            <div className="md:flex items-center justify-between py-4 px-7 md:px-[7.5em] bg-gray-200 dark:bg-gray-900 z-[2]">
                ...
                <ul className={`cursor-pointer md:flex md:items-center md:pb-0 pb-12 md:static z-[100] left-0 w-full md:w-auto md:pl-auto pl-9 transition-all duration 500 ease-in-out absolute bg-gray-200 dark:bg-gray-900 ${open ? 'top-16 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]' : 'top-[-100vh]'}`}>
