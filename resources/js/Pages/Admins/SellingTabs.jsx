        ...
        <div className="bg-[#171d23] md:w-full  min-h-[90vh] p-7 flex flex-col items-center justify-center font-body">
            <div className="bg-[#1D232A] p-7 flex flex-col gap-7 rounded-xl shadow-md w-10/12">
                <div className="text-center font-bold text-white text-2xl">
                    ...
                    {/* add kode inv */}
                    <p className="text-sm text-gray-500">Kode Invoice: {kode_inv}</p>
                </div>
                <div>
                    <form className="flex items-center gap-4 justify-center" onSubmit={handleItemIdSubmit}>
                        <input
                            type="number"
                            id="itemId"
                            name="itemId"
                        ...
                        <div className="modal-box w-11/12 max-w-xl">
                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-center gap-4">
                                    <p className="text-lg text-gray-500">Transaction ID: {transactionID}</p>
                                    <a
