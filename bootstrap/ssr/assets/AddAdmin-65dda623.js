      ...
      /* @__PURE__ */ jsx("tbody", { children: datas.data.admins.map((item, index) => /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxs("th", { children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              className: "btn bg-[#16a34a] text-white btn-xs",
        ...
        /* @__PURE__ */ jsxs("th", { children: [
          ...
          /* @__PURE__ */ jsx(
            "dialog",
            {
              id: `remove_${item.id}`,
              className: "modal",
              children: /* @__PURE__ */ jsx("div", { className: "card w-96 bg-neutral text-neutral-content", children: /* @__PURE__ */ jsxs("div", { className: "card-body items-center text-center", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "card-actions justify-end", children: /* @__PURE__ */ jsxs(
                  "form",
                  {
                    method: "dialog",
